...
Generally however, the SixMoEyes annotation is much more likely in prospective studies than in retrospective studies.

Plan:

* Impute PutativePropective from pattern of eye studies
  * Redo the analysis based on this distinction to see whether it matters much
  * Annotate pro or retro in the dataset
  * Hound the N eyes values
  * Annotate mechanism of exclusion (only included follow through..., or whatever)
